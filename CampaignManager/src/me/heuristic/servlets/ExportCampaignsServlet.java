...
public class ExportCampaignsServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		String campaignName = HtmlUtil.handleNullWhiteSpaces(req.getParameter("cname"));
		...
		String [] sCampaignNames = req.getParameterValues("cname");
		...
		if (errors.size()>0) {
			...
			if (errors.size()>0) {
				...
				pw.print(TaggedUrlService.renderTaggedUrlExportList(myAccount, sCampaignIds, delimiter));
			}
		}
	}
}
