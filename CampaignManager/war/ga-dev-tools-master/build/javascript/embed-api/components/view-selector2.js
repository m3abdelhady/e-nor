	  ...
	  gapi.analytics.createComponent('ViewSelector2', {
	    ...
	    updateAccounts_: function updateAccounts_() {
	      ...
	      if (!this.summaries.all().length) {
	        return this.emit('error', new Error('This user does not have any ' + 'Google Analytics accounts. You can sign up at ' + '"www.google.com/analytics".'));
	      }
	     ...
	     */
	    template: '<div class="ViewSelector2">' + '  <div class="ViewSelector2-item">' + '    <label>Account</label>' + '    <select class="FormField gaAccount"></select>' + '  </div>' + '  <div class="ViewSelector2-item">' + '    <label>Property</label>' + '    <select class="FormField gaProperty"></select>' + '  </div>' + '  <div class="ViewSelector2-item">' + '    <label>View</label>' + '    <select class="FormField gaView"></select>' + '  </div>' + '</div>'
	  });
