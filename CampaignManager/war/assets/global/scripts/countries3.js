...
function print_state(state_id, state_index){	
	if ($("#country").val() == "USA" || $("#country").val() == "Canada"){
		$(".stateText").replaceWith("<select required class='form-control stateSelect' name ='state' id ='state'></select>");
		...
		$("#state").replaceWith("<input required type='text' name='state' value='' class='form-control stateText'/>");
		
		
	}
}

function print_state_list(state_id){
